    ...
    <div class="top">
      <div class="flex w-11/12 lg:w-11/12 justify-between">
        ...
        <span v-else>
          ...
          >
            <img
              src="@/assets/images/icons/long_right_dark.svg"
              alt="MMM Logo"
              class="w-18 h-8"
            />
          </nuxt-link>
      ...
      <div class="flex justify-end">
        <span class="bg-[#E1C5B4]">
          <nuxt-link
            to="/cart"
            :class="`px-4 bg-[#E1C5B4] block button ${
              showSearch ? 'bg-[#E1C5B4]' : 'bg-transparent'
            }`"
          >
        ...
        <span>
          <button v-if="showClose" @click="close" class="px-5 outline-none">
            <span class="icon icon-close-shop"></span>
          </button>

          <button v-else @click="showNav = true" class="px-5">
